...
export default function CourseDataUpdate() {
  ...
  const handleCreating = (values) => {
    ...
    console.log("updated valuse : ", UpdatedValue);

    services.updateCourses(UpdatedValue).then((response) => {
      if (response.isSuccess) {
        console.log("value in response : ", UpdatedValue);
        navigate("/Courses");
                      ...
                      >
                        <Grid item xs={12} md={7} lg={7} xl={8} margin={2}>
                          <Card sx={{ borderRadius: 6 }} elevation={10}>
                            <CardHeader title="Update Course"></CardHeader>
                            <hr
                              style={{
                                color: "white",
                                marginLeft: 15,
